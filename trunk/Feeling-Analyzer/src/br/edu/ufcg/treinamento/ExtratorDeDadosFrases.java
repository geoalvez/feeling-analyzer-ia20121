...
public class ExtratorDeDadosFrases {
	...
	@SuppressWarnings("unused")//TODO outro supress
	...
	public static FraseDados obtemDadosFrases(String str, String tipoDaFrase) {
		...
		fraseDados.setNumPalavrasAgradecimento(ClassifierUtils
				.contaNumAgradecimento(str));
		...
		fraseDados.setNumPalavrasArrependimento(ClassifierUtils
				.contaNumArrependimento(str));
		fraseDados.setNumPalavrasDor(ClassifierUtils.contaNumDor(str));
		fraseDados.setNumPalavrasNegativas(ClassifierUtils
				.contaNumNegativeWords(str));
		fraseDados.setNumPalavrasAfirmativas(ClassifierUtils
				.contaNumAfirmativeWords(str));

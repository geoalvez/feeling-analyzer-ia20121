...
public class ClassifierUtils {
		...
		try {
			...
			while (in.ready()) {
				...
				if (str.startsWith(AGRADECIMENTO)) {
					...
					AGRADECIMENTO_LIST = Arrays.asList(str
							.split(REGEX_SPIT_ARQ_CONF));
			...
			System.out.println("Falha ao tentar ler o arquivo informado ["
					+ file + "].");
		}
	...
	public static int contaNumAgradecimento(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam agradecimento foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumPrazer(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam prazer foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumPerda(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam perda foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumEuforia(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam euforia foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumSadWord(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam 'sad words' foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumBadWord(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam 'bad words' foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumGoodEmoticons(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam 'good emoticons' foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumBadEmoticons(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam 'bad emoticons' foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumArrependimento(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam arrependimento foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumDor(String frase) {
		...
		System.out.println(count
				+ " palavras que caracterizam dor foram encontradas na frase ["
				+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumNegativeWords(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam 'negative words' foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
	...
	public static int contaNumAfirmativeWords(String frase) {
		...
		System.out
				.println(count
						+ " palavras que caracterizam 'afirmative words' foram encontradas na frase ["
						+ frase + "]. ");
		return count;
	}
}
